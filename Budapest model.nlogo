...
globals [
  ...
  park
  districts
  groningen_population ;; is in reality budapest population data
  internal-clock
]
...
humats-own [
  ...
  ;;meeting-participant true/false if participating in the meeting 1 if not 0
]
...
<experiments>
  ...
  <experiment name="budapest model" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>ticks</metric>
    <metric>precision (Voter-%A * 100) 2</metric>
